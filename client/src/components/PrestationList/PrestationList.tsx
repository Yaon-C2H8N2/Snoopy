...
const PrestationList = () => {
  ...
  const handleValidate = (prestation: PrestationIntervention) => {
    navigate("/prestation/recap", {
      state: { idPrestationIntervention: prestation.idPrestationIntervention },
    });
  };
                ...
                return (
                  <TableRow key={prestation.idPrestationIntervention}>
                    <TableCell className={"text-center"}>
                      {prestation.idPrestationIntervention}
                    </TableCell>
                    <TableCell className={"text-center"}>
                      {
                        clients.find(
                          (client) => client.idClient === prestation.idClient,
                        )?.nomEntreprise
                      }
                    </TableCell>
                    <TableCell className={"text-center"}>
                    ...
                    <TableCell className={"text-center"}>
                      {prestation.interieur && prestation.exterieur
